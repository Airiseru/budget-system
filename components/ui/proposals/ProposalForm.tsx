...
export default function ProposalForm({
    ...
    const [bp203Selections, setBp203Selections] = useState<
        Record<
            number,
            { category?: Bp203FundCategory; method?: Bp203FundMethod }
        >
    >({});
    ...
    async function handleSubmit(e: React.SyntheticEvent<HTMLFormElement>) {
        ...
        const normalizedComponents = payload.cost_by_components.map((comp) => {
                    ...
                    ? normalizeBp203CostRows({
                          ...
                          costs: comp.costs.length
                              ? comp.costs.map((cost) => ({
                                    ...cost,
                                    expense_class:
                                        cost.expense_class || expenseClass,
                                }))
                              : [
                                    {
                                        expense_class: expenseClass,
            ...
            return {
                ...comp,
                component_name: selectedItem?.name || comp.component_name || "",
                tier: 2 as const,
                currency: comp.currency || costs[0]?.currency || "PHP",
                proposed_amt: Number(
                    comp.proposed_amt || getCostRowsTotal(costs) || 0,
                ),
                costs,
            };
        });
        const normalizedLocalFinancialAttributions =
            payload.local_financial_attributions.map((attribution) => ({
                ...attribution,
        ...
        <>
            ...
            >
                        ...
                        <div className="space-y-4">
                            ...
                            {!hasExistingPaps && (
                                <p className="text-sm text-muted-500">
                                    No existing PAPs available. Proposal is
                                    locked to New Project.
                                </p>
                            )}
                                        ...
                                        onValueChange={(value) => {
                                            ...
                                            if (selectedPap) {
                                                setPayload((prev) => ({
                                                    ...
                                                    description:
                                                        selectedPap.description ??
                                                        "",
                                                    org_outcome_id:
                                                        selectedPap.org_outcome_id,
                                                    purpose:
                                                        selectedPap.purpose,
                                                    beneficiaries:
                                                        selectedPap.beneficiaries,
                                                    is_infrastructure:
                                                        selectedPap.is_infrastructure ??
                                                        false,
                                                    for_ict:
                                                        selectedPap.for_ict ??
                                                        false,
                        ...
                        <CollapsibleTableSection
                            ...
                            summary={
                                <div className="text-sm text-muted-500 italic">
                                    <div>
                                        {payload.cost_by_components.length}{" "}
                                        components configured
                                    </div>
                                    {/* Totals Section */}
                                    {payload.cost_by_components.length > 0 && (
                                        <div className="border-muted-200 border-t bg-muted-50/70 px-5 py-4">
                                            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                                                {/* Label */}
                                                <div>
                                                    <h4 className="text-sm font-bold text-muted-700">
                                ...
                                "
                                    ...
                                    {payload.cost_by_components.length ===
                                        0 && (
                                        <div className="p-8 text-center text-muted-400 text-sm italic">
                                            No component allocations added.
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                <CollapsibleTableSection
                                    ...
                                    collapsed={
                                        collapsedSections.local_locations
                                    }
                                    onToggle={() =>
                            ...
                            >
                                <CollapsibleTableSection
                                    ...
                                    summary={
                                        <div className="text-sm text-muted-500 italic">
                                            {
                                                payload.local_physical_targets
                                                    .length
                                            }{" "}
                                            targets added.
                                        </div>
                                ...
                                >
                                    ...
                                    {payload.local_physical_targets.length ===
                                        0 && (
                                        <div className="p-8 text-center text-muted-400 text-sm italic">
                                            No Local Physical Targets added.
                                            Click &quot;+ ADD TARGET&quot; to
                                            begin.
                                        </div>
                                    )}
                ...
                hover:opacity-90  "
                            ...
                            {getErrorsForPath("foreign_financial_targets")
                                .length > 0 && (
                                <div className="bg-red-50 border border-red-100 p-3 rounded-lg mb-4">
                                    {getErrorsForPath(
                                        "foreign_financial_targets",
                ...
                hover:opacity-90  "
                            ...
                            {getErrorsForPath("foreign_physical_targets")
                                .length > 0 && (
                                <div className="bg-red-50 border border-red-100 p-3 rounded-lg mb-4">
                                    {getErrorsForPath(
                                        "foreign_physical_targets",
