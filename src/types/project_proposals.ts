...
export type LocalFinancialAttribution = Selectable<LocalFinancialAttributionTable>
...
export type LocalInfrastructureRequirement = Selectable<LocalInfrastructureRequirementTable>
