...
export const ExpenseRowSchema = z.object({
  expense_class: z.enum(["PS", "MOOE", "CO", "FE"]),
...
export const ProposalSchema = z.object({
  ...
  proposal_year: z.number().min(1987, "The Fifth Philippine Republic began at 1987"),
