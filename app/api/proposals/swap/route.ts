    ...
    try {
        ...
        if (body.action === "move") {
            ...
            const requestedYear = Number(
                body.proposalYear ?? body.proposal_year,
            );
            const movingProposal =
                await ProposalRepository.getProjectProposalById(proposalId);
            ...
            const currentProposals =
                await ProposalRepository.getAllProposalSummaries(
