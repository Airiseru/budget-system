...
export async function up(db: Kysely<unknown>): Promise<void> {
    await db.schema
        ...
        .addColumn('target_table', 'varchar', (col) => col.notNull()) // e.g., 'forms', 'disbursements'
        ...
        .addColumn('justification_remark', 'text', (col) => col.notNull()) // Reason for the override/overwrite
