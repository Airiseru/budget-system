...
export async function up(db: Kysely<unknown>): Promise<void> {
    ...
    await db.schema
        ...
        .addColumn('date_of_birth', 'timestamptz', (col) => col.notNull())
        .addColumn('original_appointment', 'timestamptz', (col) => col.notNull())
        .addColumn('retirement_effectivity', 'timestamptz', (col) => col.notNull())
